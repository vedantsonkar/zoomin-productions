...
const AboutUsSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        At Griffin Pictures, our aim is to bring an idea to reality with a touch
        of imagination. As a video production company in Mumbai, we create
        content on various verticals, whilst housing the most eminent brands in
        the country. Our belief is to bring value and distinction with
        conviction.
      </motion.p>
      <motion.p
      ...
      >
        ...
        journey began as a group of highly enthusiastic youngsters, having a
        collective experience of more than 20 years. We always believe in
        delivering a creative solution that is best suited for a brand. We
        thrive on being able to deliver the best there is to offer, combining
