            ...
            <div className='mx-auto px-4'>
              <blockquote className='twitter-tweet'>
                <p lang='hi' dir='ltr'>
                  ...
                  <a href='https://t.co/HflN9aEGip'>
                    pic.twitter.com/HflN9aEGip
                  </a>
                </p>
                &mdash; BJP (@BJP4India){' '}
            ...
            <div className='px-4'>
              <blockquote className='twitter-tweet'>
                <p lang='hi' dir='ltr'>
                  ...
                  <a href='https://t.co/zbVbUdCVH3'>
                    pic.twitter.com/zbVbUdCVH3
                  </a>
                </p>
            ...
            <div className='px-4'>
              <blockquote className='twitter-tweet px-4'>
                <p lang='en' dir='ltr'>
                  ...
                  <a href='https://t.co/IqrRWRGtIn'>
                    pic.twitter.com/IqrRWRGtIn
                  </a>
                </p>
            ...
            <div className='px-4'>
              <blockquote className='twitter-tweet px-4'>
                <p lang='en' dir='ltr'>
                  ...
                  <a href='https://t.co/RvtIUrMtNp'>
                    pic.twitter.com/RvtIUrMtNp
                  </a>
                </p>
